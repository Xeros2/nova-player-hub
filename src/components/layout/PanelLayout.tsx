...
const navItems = [
  ...
  { href: "/panel/activate", label: "Activate", icon: Zap },
  { href: "/panel/playlists", label: "Playlists", icon: List },
];
        ...
        <div className="flex flex-col h-full">
          ...
          <div className="p-6 border-b border-border">
            <Link to="/" className="flex items-center gap-3">
              ...
              <span className="text-xs text-primary font-medium px-2 py-0.5 bg-primary/10 rounded">USER</span>
            </Link>
          </div>
      ...
      <div className="flex-1 flex flex-col min-h-screen">
        ...
        <header className="h-16 border-b border-border flex items-center px-4 lg:px-6">
          ...
          <div className="flex-1">
            <h1 className="font-display font-semibold">User Panel</h1>
          </div>
        </header>
